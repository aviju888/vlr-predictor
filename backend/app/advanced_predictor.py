...
# Add the project root and misc/scripts to the path
project_root = Path(__file__).parent.parent.parent
misc_scripts_path = project_root / "misc" / "scripts"
sys.path.insert(0, str(misc_scripts_path))
sys.path.insert(0, str(project_root))

# Import the training system components from misc/scripts

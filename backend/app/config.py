...
class Settings(BaseSettings):
    ...
    # Model (artifacts is in backend/artifacts, same level as app/)
    model_path: str = os.path.join(os.path.dirname(os.path.dirname(__file__)), "artifacts", "realistic_model.joblib")
